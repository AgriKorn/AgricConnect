...
mixin _$AuthResponseModel {
  ...
  AccountStatus get verificationStatus => throw _privateConstructorUsedError;
...
class _$AuthResponseModelImpl implements _AuthResponseModel {
  ...
  @override
  String toString() {
    return 'AuthResponseModel(accessToken: $accessToken, refreshToken: $refreshToken, role: $role, verificationStatus: $verificationStatus, user: $user)';
  }
...
abstract class _AuthResponseModel implements AuthResponseModel {
  const factory _AuthResponseModel({
    ...
    required final AccountStatus verificationStatus,
  ...
  UserRole get role;
  @override
  AccountStatus get verificationStatus;
  @override
  UserModel get user;
