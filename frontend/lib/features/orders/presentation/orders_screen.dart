...
/// Buyer Orders: Active/History/Cancelled tabs -> Active Shipments (escrow
/// tracking, farmer contact) -> Recent History teaser.
                      ...
                      OrdersTab.active => [
                        ...
                        if (activeShipments.isEmpty)
                          ...
                          for (final shipment in activeShipments) ...[
                            _ActiveShipmentCard(colorScheme: colorScheme, shipment: shipment),
...
class _ActiveShipmentCard extends StatelessWidget {
  const _ActiveShipmentCard({required this.colorScheme, required this.shipment});
          ...
          Row(
            ...
            children: [
              ...
              if (hasFarmer)
                ...
                OutlinedButton(
                  onPressed: () => _openComingSoon(context, 'Order Details', Icons.receipt_long_rounded),
